    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                {{-- About --}}
                <li class="nav-item">
                    <a class="nav-link {{ ($route == 'about.edit')?'active':'' }}" href="{{ route('about.edit') }}">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                    ...
                    <ul class="sub-nav collapse" id="sidebar-whyUs" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link {{ ($route == 'whyUs.list')?'active':'' }}"
                                ...
                                <span class="item-name">All cards</span>
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                <li class="nav-item {{ ($prefix == '/services')?'open':'' }}">
                    <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-services" role="button"
                        aria-expanded="false" aria-controls="sidebar-services">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                    ...
                    <ul class="sub-nav collapse" id="sidebar-services" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                ...
                <li class="nav-item {{ ($prefix == '/testimonials')?'open':'' }}">
                    <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-testimonials" role="button"
                        aria-expanded="false" aria-controls="sidebar-testimonials">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                    ...
                    <ul class="sub-nav collapse" id="sidebar-testimonials" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                ...
                {{-- team --}}
                <li class="nav-item {{ ($prefix == '/team')?'open':'' }}">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-team" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link {{ ($route == 'team.list')?'active':'' }}"
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ ($route == 'team.form')?'active':'' }}"
                                href="{{ route('team.form') }}">
                                <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                        fill="currentColor">
                                        <g>
                ...
                {{-- clients --}}
                <li class="nav-item {{ ($prefix == '/clients')?'open':'' }}">
                    <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-clients" role="button"
                        aria-expanded="false" aria-controls="sidebar-clients">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                    ...
                    <ul class="sub-nav collapse" id="sidebar-clients" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link {{ ($route == 'clients.list')?'active':'' }}"
                                ...
                                <span class="item-name">All Clients</span>
                            </a>
                        </li>
                        <li class="nav-item">
